...
INSERT INTO `cc_company` (`id`, `cts`, `uts`, `name`, `id_path`, `pid`, `company_code`, `gmt`, `contact`, `phone`, `balance`, `bill_type`, `pay_type`, `hidden_customer`, `secret_type`, `secret_key`, `ivr_limit`, `agent_limit`, `group_limit`, `group_agent_limit`, `record_storage`, `notify_url`, `ext1`, `ext2`, `ext3`, `ext4`, `ext5`, `status`) VALUES (17, 0, 0, '曹亮测试企业', '', 0, 'dongjb', 0, '', '', 0, 0, 0, 0, 2, 'LHPhqMTSNHsfQrGE', 100, 100, 10, 1000, 0, '', '', '', '', '', '', 0);
COMMIT;
