...
public class RouteGroup implements Serializable {
    ...
    public void setRouteGroup(String routeGroup) {
        this.routeGroup = routeGroup == null ? null : routeGroup.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", routeGroup=").append(routeGroup);
    ...
    public boolean equals(Object that) {
        ...
        RouteGroup other = (RouteGroup) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getRouteGroup() == null ? other.getRouteGroup() == null : this.getRouteGroup().equals(other.getRouteGroup()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getRouteGroup() == null) ? 0 : getRouteGroup().hashCode());
