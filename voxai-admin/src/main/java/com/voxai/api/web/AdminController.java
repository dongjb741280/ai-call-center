...
public class AdminController extends BaseController {
    ...
    @Value("${voxai.minio.server:}")
    private String ossServer;
    @Value("${voxai.minio.endpoint:}")
     ...
     */
    @GetMapping("company")
    public CommonResponse<com.voxai.core.page.Page<Company>> companyList(@ModelAttribute("adminAccountInfo") AdminAccountInfo adminAccountInfo, PageInfo pageInfo, String query) {
        Map<String, Object> params = parseMap(adminAccountInfo, pageInfo, query);
    ...
    public CommonResponse<Long> addUser(@ModelAttribute("adminAccountInfo") AdminAccountInfo adminAccountInfo, @RequestBody AdminUser adminUser) {
        ...
        if (adminUser.getPasswd() != null && !adminUser.getPasswd().isEmpty()) {
            adminUser.setPasswd(com.voxai.api.util.BcryptUtil.encrypt(adminUser.getPasswd()));
        }
    ...
    @Autowired
    private com.voxai.core.mapper.PlaybackMapper playbackMapper;
