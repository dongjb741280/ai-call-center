...
import com.voxai.cc.websocket.response.AgentStateResppnse;
...
public class AgentServiceImpl extends BaseServiceImpl<Agent> implements AgentService {
    ...
    public AgentInfo getAgentInfo(String agentKey) {
        ...
        agentInfo.setGroupId(agentGroupMapper.selectByAgent(agent.getId()).get(0));
        agentInfo.setLoginType(1);
        return agentInfo;
    }
