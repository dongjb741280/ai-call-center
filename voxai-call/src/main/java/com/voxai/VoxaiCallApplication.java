...
import com.voxai.core.util.SnowflakeIdWorker;
...
import com.voxai.cc.tcp.TcpServer;
import com.voxai.cc.websocket.WebSocketManager;
...
public class VoxaiCallApplication implements CommandLineRunner, ApplicationListener<ContextClosedEvent> {
    private Logger logger = LoggerFactory.getLogger(VoxaiCallApplication.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(VoxaiCallApplication.class, args);
    }
